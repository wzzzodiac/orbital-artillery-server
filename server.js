...
const httpServer = createServer((req, res) => {
  if (req.url === '/health') { res.writeHead(200, { 'content-type': 'application/json; charset=utf-8' }); res.end(JSON.stringify({ ok: true, service: 'orbital-artillery-server', phase: '9-v0.9.7-pre-release', version: '0.9.7-pre-release', rooms: roomStore.size, sockets: io?.engine?.clientsCount ?? 0 })); return; }
