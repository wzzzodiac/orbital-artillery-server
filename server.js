...
const httpServer = createServer((req, res) => {
  if (req.url === '/health') { res.writeHead(200, { 'content-type': 'application/json; charset=utf-8' }); res.end(JSON.stringify({ ok: true, service: 'orbital-artillery-server', phase: '9-v0.9.6-beta', version: '0.9.6-beta', rooms: roomStore.size, sockets: io?.engine?.clientsCount ?? 0 })); return; }
